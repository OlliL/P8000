...
# define RLEFT	0x0001
# define RRIGHT	0x0002
# define RESC1 	0x0004
# define RESC2 	0x0008
# define RESC3 	0x0010
# define RESC4 	0x0020
# define RESCC 	0x0040
# define RNOP	0x0080    /* DANGER: can cause loops.. */
# define RNULL 	0x0100    /* clobber result */
# define RHIGHT	0x0200
# define RLOW	0x0400
...
# define NREG 01
# define NMASK 0777
# define LSHARE  0x1000 /* share left register */
# define RSHARE  0x2000 /* share right register */
# define LPREF   0x4000 /* prefer left register, if any */
# define RPREF   0x8000 /* prefer right register, if any */
#define NPAIR	0x400 /* need Pair */
#define NQUAD	0x200 /* need Quadrupel */

# define NCOUNT 0x000f /* allocate registers in shorts*/
# define PCOUNT 0x00f0 /* allocate registers in pairs */
# define QCOUNT 0x0f00 /* allocate registers in quads */
...
#define callreg(x) ( x->in.type == TDOUBLE ? 0 : 2 )
#endif
#ifndef szty
