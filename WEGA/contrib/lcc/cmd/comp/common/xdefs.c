...
TWORD	ftntype; /* type of function. Has had FTN indicator DECREF'd */
...
long	paramstk[ PARAMSZ ];  /* holds symtab indices of function parameters */
int	paramno;	  /* the number of parameters */
OFFSZ	argsoff[ ARGSZ ];  /* the offsets for the arguments */
