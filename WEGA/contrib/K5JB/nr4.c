...
unsigned Nr4retries = 6;		/* Max retries reduced from 10 */
...
long Nr4choketime = 180000L ;	/* CHOKEd state timeout */
...
unsigned seq ;
{
	...
	/* limit this to less than T4 minus 30 sec */
	t->start = backoff < t4init - 30000L/MSPTICK ? backoff :
		t4init - 30000L/MSPTICK;
	start_timer(t) ;
