...
/*
 * Text structure.  One allocated per pure procedure on swap device.
 * Manipulated by text.c
 */

struct text
{
	short		x_daddr;	/* swap address of segment 	*/
...
# define XTRC		01		/* may be written, exclusive use*/
# define XWRIT		02		/* written into, must swap out 	*/
