...
*******************************************************************************
	...
	P8000-PROM (MONITOR)	Modul: p_init
...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
  ...
  INTERNAL
COPYRIGHT
	ARRAY	[* BYTE]	:= '(C) ZFT/KEAW Berlin, DATE 15.04.1987'
...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
  ...
  INTERNAL
SYSMSG	WORD := 46
	ARRAY [* BYTE] := 'U8000-Softwaremonitor Version 2.0 - '
...
ITAB_SIO0_A ARRAY [* BYTE] := [COMM3
                               SIO_R4 + COMM2
                               S2 + C32 + NOPRTY       !original S2+C64+NOPRTY!
                               SIO_R3
                               RENABLE + B8
                               SIO_R5
                               XENABLE + T8 + DTR + RTS
