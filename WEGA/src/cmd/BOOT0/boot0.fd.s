...
*******************************************************************************
	...
	Standalone	Module boot0.fd.s (primary bootstrapper)
 
 
	Bearbeiter:	P. Hoge
	Datum:		04/01/87 11:20:20
	Version:	1.1
 
*******************************************************************************
 
	fuer einen Systemstart von der Floppydisk (WEGA-Format)
...
MAIN10:
	inc	r9, #14
	cp	r9, #DISK_BUFFER+%200 !Ende Floppydisk Puffer!
...
!*---------------------------------------------------------------------------*!
!*
 * 1 Block von Floppydisk einlesen
 *!
!*---------------------------------------------------------------------------*!
...
!*---------------------------------------------------------------------------*!
!*
 * Lesen 1 Block von Floppydisk in Puffer
 * Es wird der Floppydisktreiber im Monitor benutzt
 *!
!*---------------------------------------------------------------------------*!
