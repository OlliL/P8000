...
*******************************************************************************
	...
	Modifiziert:	AFIO, jg, 23.02.94
	dev-bit 0x10 :  kein 0x0c beim close
	        0x20 :	keine Umschaltung auf raw-Mode
		0x40 :	permanenter raw-Mode
		0x80 :	lp2-Parameter, (veraendert)
...
struct lprint lp2_dt = {90, 160, 0, 0, 0, 0, 0};
...
int flag;
{
	...
	sioioctl((dev & 0xff0f), cmd, addr, flag);
}
